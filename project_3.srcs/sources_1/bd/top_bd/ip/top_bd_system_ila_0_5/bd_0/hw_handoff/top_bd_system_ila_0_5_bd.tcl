...
################################################################
# This is a generated script based on design: bd_5b0d
#
...
proc create_root_design { parentCell } {
  ...
  set probe6 [ create_bd_port -dir I -from 64 -to 0 probe6 ]
  set probe7 [ create_bd_port -dir I -from 64 -to 0 probe7 ]
  set probe8 [ create_bd_port -dir I -from 64 -to 0 probe8 ]
  set probe9 [ create_bd_port -dir I -from 64 -to 0 probe9 ]
  set probe10 [ create_bd_port -dir I -from 64 -to 0 probe10 ]
  set probe11 [ create_bd_port -dir I -from 64 -to 0 probe11 ]
  set probe12 [ create_bd_port -dir I -from 64 -to 0 probe12 ]
  set probe13 [ create_bd_port -dir I -from 64 -to 0 probe13 ]
  ...
  set probe25 [ create_bd_port -dir I -from 64 -to 0 probe25 ]
